        ...
        <div class="card">
            <div class="card-body p-3 p-md-4">
                <form action="{{ route('service-orders.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-bold">📸 Registro de Problemas e Fotos (Opcional)</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <small class="text-muted">Selecione uma opção acima ou digite manualmente</small>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <small class="text-muted d-block mt-1">
                        <i class="bi bi-camera"></i> Use a câmera ou selecione da galeria. Você pode adicionar várias fotos (clique novamente para adicionar mais).
                    </small>
                </div>
